...
PROMPT >> Flows4APEX My Task Inbox Installation
PROMPT >> =====================================
...
ACCEPT app_alias char default 'FLOWS4APEXINBOX' PROMPT 'Enter Application Alias: [FLOWS4APEXINBOX]'
ACCEPT app_name char default 'Flows for APEX My Task Inbox' PROMPT 'Enter Application Name: [Flows for APEX My Task Inbox]'
...
PROMPT >> Finished Installation of Flows4APEX My Task Inbox 
PROMPT >> =================================================
